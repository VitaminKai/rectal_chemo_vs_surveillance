...
>Next we aimed to compare the OS and RFS between adjuvant chemo and surveillance group using multivariate logistical regression accounting for known clinical prognostic factors. Variables contained groups with very small number of samples (<4) were removed. 
